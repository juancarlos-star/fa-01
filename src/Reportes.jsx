...
const SIN_FILTRO_FECHA = ['clientes', 'clientesFrecuentes', 'historial', 'gestionProductos', 'inventarioProductos', 'inventarioFisico', 'stockBajo', 'stockMuerto', 'vendedoresUltimasVentas', 'ventasCierreDiario', 'etiquetas', 'metasComisiones'];
